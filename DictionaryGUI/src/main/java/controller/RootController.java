...
public class RootController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        loadData();
        searchList();
        webView.getEngine().loadContent("Nice to meet you, Bạn có thể nhập từ vào Search Bar và Enter để tra từ!");
    }
    ...
    public void handle(ActionEvent actionEvent) {
        ...
        if (!words.haveWord(x)) {
            webView.getEngine().loadContent("Không có từ này trong từ điển. Bạn có thể nhập từ khác hoặc thêm từ này vào từ điển!");
        } else {
            WebEngine webEngine = webView.getEngine();
    ...
    public void searchWordType(KeyEvent keyEvent) {
        if(searchWord.getText().equals("")){
            webView.getEngine().loadContent("Vui lòng nhập từ cần tìm vào Search Bar và Enter để tra từ!");
        }
    }
...
//        stage.show();
    ...
    public void helpAction(MouseEvent mouseEvent) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/panel/help_panel.fxml"));
        Scene scene = new Scene(root);
        Stage stage = new Stage(StageStyle.DECORATED);
        stage.setTitle("Help!");
        stage.setScene(scene);
    ...
    public void updateData(MouseEvent mouseEvent) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/panel/update_panel.fxml"));
        Scene scene = new Scene(root);
        Stage stage = new Stage(StageStyle.DECORATED);
